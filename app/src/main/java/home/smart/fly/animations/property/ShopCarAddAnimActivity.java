...
public class ShopCarAddAnimActivity extends BaseActivity implements
    ...
    private void addToCarAnimation(ImageView goodsImg) {
        ...
        goodsImg.getLocationOnScreen(animImgLocation);
        int shellLocation[] = new int[2];
        findViewById(R.id.head).getLocationInWindow(shellLocation);
        ...
        float startY = animImgLocation[1] - shellLocation[1] + goodsImg.getHeight() / 2 - params.height / 2;
        Log.e("num01", "-------->" + animImgLocation[1] + " " + shellLocation[1] + " " + goodsImg.getHeight() / 2 + DpConvert.dip2px(mContext, 10.0f));
        Log.e("num1", "-------->" + startX + " " + startY);
