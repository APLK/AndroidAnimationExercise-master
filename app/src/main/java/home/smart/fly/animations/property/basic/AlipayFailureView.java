...
public class AlipayFailureView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        //        canvas.drawLine(mCenterX - mRadius / 2 , mCenterY - mRadius / 2 , mCenterX- mRadius / 2 + mLeftValue, mCenterY- mRadius / 2 +  mLeftValue, mLinePaint);
        //        canvas.drawLine(mCenterX + mRadius / 2, mCenterY - mRadius / 2 , mCenterX+ mRadius / 2 - mRightValue, mCenterY - mRadius / 2 +  mRightValue, mLinePaint);
    }
    ...
    public void startAnim(int mRadius) {
        ...
        //        mLineLeftAnimator = ValueAnimator.ofFloat(0, this.mRadius);
        //        mLineRightAnimator = ValueAnimator.ofFloat(0, this.mRadius);
